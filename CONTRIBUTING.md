...
Before creating a new issue, please search existing [issues](https://github.com/communityox/ox_inventory/issues) to see if it has already been reported.
...
- If you have modified or introduced new APIs, open a pull request to our [documentation](https://coxdocs.dev/). We will not accept undocumented code.
